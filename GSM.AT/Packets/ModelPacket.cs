...
{
    public class ModelPacket : GenericPacket
    {
        new public static string Command = "AT+GMM";
        public static string ActionCommand() { return Command; }
        public static string TestCommand() { return Command + "=?"; }

        public ModelPacket(string requestString) : base(requestString) { }
            ...
            get
            {
                ...
                switch (this.Type)
                {
                    case PacketType.Action:
                        packetMessage = "Phone model name: \t{0}";
                        break;
                    case PacketType.Set:
                ...
                return String.Format(packetMessage, this.Model);
            }
        }
    }
}
