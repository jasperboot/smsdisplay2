...
{
    public class SamsungNumberPacket : GenericPacket
    {
        new public static string Command = "AT#PBDYN";
        public static string ReadCommand() { return Command + "?"; }
        public static string TestCommand() { return Command + "=?"; }

        public SamsungNumberPacket(string requestString) : base(requestString) { }
        ...
        public string PhoneNumber
        {
            get
            {
                ...
                foreach (string dataLine in _data)
                {
                    ...
                    if (details.Length > 0) pn = details[0];
                }
                return pn;
            }
        }
            ...
            get
            {
                ...
                switch (this.Type)
                {
                    ...
                    case PacketType.Read:
                        packetMessage = "Current phone number (samsung command): \t{0}";
                        break;
                }
